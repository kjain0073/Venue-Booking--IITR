...
class CalenderPage2 extends Component {
    constructor(props){
        super(props);
        this.state = {
            date: new Date(),
                        ...
                        <Row>
                            <Col lg={4} className="d-flex align-items-center justify-content-center">
                                ...
                                <Calendar
                                        ...
                                        minDate={new Date()}
                                    />
                                    <Link to={`/admin1/venue-page?date=${this.state.date.getDate()}&month=${this.state.date.getMonth() + 1}&year=${this.state.date.getFullYear()}`} style={{textDecoration:"none", padding:"2px"}}>
                                        <Button color="success" outline block>Book Venue at selected date?</Button>
                                    </Link>
                                </Card>
                            </Col>
